...
export default function ImportModal({
  ...
  const exampleTemplate = `Date,Symbol,Action,Lots,Entry,Exit,PnL,Notes
2026-05-21,EURUSD,BUY,0.1,1.12000,1.12500,50.00,Aligned with plan
2026-05-22,XAUUSD,SELL,0.05,2010.50,2005.00,27.50,Gold scalp success`;
  ...
  const handleTextChange = (text: string) => {
    ...
    try {
      ...
      // Detect header row
      let hasHeader = false;
      let headers = ['date', 'symbol', 'action', 'lots', 'entry', 'exit', 'pnl', 'notes']; // fallback Order
      ...
      for (let i = startIndex; i < lines.length; i++) {
        ...
        if (hasHeader) {
          ...
          // Fallback simple column order: Date, Pair, Action, Lots, Entry, Exit, PnL, Notes
        ...
        <div className="p-5 space-y-4 overflow-y-auto flex-1 font-sans text-left">
          ...
          <div className="bg-cat-base border-2 border-cat-surface0 rounded-2xl p-4 text-[11px] leading-relaxed relative shadow-xs">
            ...
            <code className="block mt-1 bg-cat-mantle text-[10px] font-semibold font-mono text-cat-pink p-2 rounded-lg border border-cat-surface0 select-all leading-tight">
              Date, Symbol, Action, Lots, Entry, Exit, PnL, Notes
            </code>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g.&#10;2026-05-21,EURUSD,BUY,0.1,1.12000,1.12500,50.00,Target reached&#10;2026-05-22,XAUUSD,SELL,0.05,2010.5,2005,27.5,Retracement scale"
                  ...
                  return (
                    <div key={idx} className="p-3 flex items-center justify-between text-cat-text hover:bg-cat-surface0/30">
                      <div className="space-y-0.5">
                        ...
                        <div className="text-[9px] text-cat-subtext font-bold">
